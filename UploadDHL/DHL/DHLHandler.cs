...
namespace UploadDHL
{
    class DHLHandler: VendorHandler
    {
        ...
        public void Next(string line)
        {
            ...
            LineNumber++;
            var iLine = AddInvoiceLine(line, 1, E_INI);
            var dhlRecord = new DHLRecord(line, zTranslation,LineNumber);
            ...
            RegisterIvoceLine(dhlRecord.XmlRecord, iLine);

            var rec = dhlRecord.XmlRecord;
